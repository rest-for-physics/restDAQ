...
int Fem_Action(Fem *fem,
			   unsigned short adr,
			   void *dat, 
			   unsigned short action);
int Fem_RegisterWrite(Fem *fem,
					  unsigned short adr,
					  void *dat,
					  unsigned short msk,
					  unsigned short sz);
int Fem_RegisterRead(Fem *fem,
					 unsigned short adr,
					 void *dat,
					 unsigned short msk,
					 unsigned short sz);
...
int Fem_PulserDacWrite(Fem *fem,
					   unsigned short fec,
					   unsigned short *val);
int Fem_PulserDacRead(Fem *fem,
					  unsigned short fec,
					  unsigned short *val);

// Functions to program registers of the front-end ASICs
int Fem_AsicWrite(Fem *fem,
				  unsigned short fec,
				  unsigned short asic,
				  unsigned short adr,
				  unsigned short *val);
int Fem_AsicRead(Fem *fem,
				 unsigned short fec,
				 unsigned short asic,
				 unsigned short adr,
				 unsigned short *val);
...
int Fem_GetChannelByCoordinates(
	unsigned short x,
	unsigned short y,
	unsigned short *fec,
	unsigned short *asic,
...
unsigned short Fem_GetPedThrAddr(Fem *fem,
								 unsigned short fec,
								 unsigned short asic,
								 unsigned short channel,
								 unsigned short base);
